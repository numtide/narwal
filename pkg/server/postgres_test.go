...
//nolint:gochecknoglobals // Test state shared across benchmarks.
var testDBCount atomic.Int32
...
func startPostgresServer(ctx context.Context) (*postgresServer, error) {
	...
	//nolint:gosec // Arguments are controlled test constants, not user input.
